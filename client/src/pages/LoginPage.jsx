...
const LoginPage = () => {
    ...
    const handleGoogleLogin = () => {
        alert("Google Login is not configured without API Keys. This is a UI demo.");
    };
            ...
            >
                ...
                <div className="card">
                    ...
                    <div className="mt-6 text-center text-sm text-gray-500">
                        ...
                        <Link to="/signup" className="text-primary-500 hover:text-primary-400 hover:underline">
                            Sign up
                        </Link>
                    </div>
                </div>
